        ...
        <div className="overflow-hidden rounded-lg bg-gradient-to-r from-indigo-950 to-indigo-950 py-8 px-4 sm:px-8 shadow-lg">
          ...
          <form
            ...
            <input
              ...
              className="flex-1 rounded-lg bg-gray-800/50 px-2 py-2 text-white placeholder-gray-400 shadow-inner transition-all focus:bg-gray-800/70 focus:outline-none focus:border-purple-400 border-2 border-gray-500"
            />
            <Button
